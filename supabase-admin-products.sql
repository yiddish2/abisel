...
values
  ...
  ('77777777-7777-4777-8777-777777777777', 'Signature Wine Presentation Box', 'gifts', 68, 'A premium rigid wine box with ribbon finish, bottle space, and a personal note card.', 'Presentation box', 'https://images.unsplash.com/photo-1606761568499-6d2451b23c66?auto=format&fit=crop&w=900&q=80'),
  ('88888888-8888-4888-8888-888888888888', 'Double Bottle Gift Case', 'gifts', 118, 'Two curated bottles packed in a keepsake-style gift case with soft fill and ribbon.', 'Two bottles', 'https://images.unsplash.com/photo-1560148218-1a83060f7b32?auto=format&fit=crop&w=900&q=80'),
  ('99999999-9999-4999-8999-999999999999', 'Corporate Wine Box Set', 'gifts', 156, 'A branded-style wine gift set for clients, hosts, donors, and special thank-yous.', 'Premium packaging', 'https://images.unsplash.com/photo-1512909006721-3d6018887383?auto=format&fit=crop&w=900&q=80')
